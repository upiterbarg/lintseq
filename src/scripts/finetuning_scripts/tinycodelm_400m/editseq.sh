...
accelerate launch \
    ...
    finetune.py \
    --use_flash_attn \
    --model_name_or_path upiter/TinyCodeLM-400M \
    --tokenizer_name upiter/TinyCodeLM-400M \
    ...
    --reduce_loss sum \
    --output_dir output/tinycodelm_400m_merged_instruct_editseq_s${NUM_EDIT_SEQS_PER_EXAMPLE}_lr3e-4_redsum \
    --with_tracking \
    --report_to wandb \
